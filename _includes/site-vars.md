...
{% for v in site.defaults %}{{ v[0] }}: {{ v[1] | jsonify }}{% endfor %}
```
...
{% for v in site.data %}{{ v[0] }}: {{ v[1] | jsonify }}{% endfor %}
```
...
{% for v in site.tags %}{{ v[0] }}: {{ v[1] | jsonify }}{% endfor %}
```
...
{% for v in site.categories %}{{ v[0] }}: {{ v[1] | jsonify }}{% endfor %}
```
