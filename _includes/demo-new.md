Hero text with [red text]{: .text-red } is dramatic
{: .hero }
...
Writing an article can be exciting when you can add few things here and there.
The `big-first` class enlarges the first letter of a paragraph.
The `text-justify` class neatly aligns your text to its container.
You can also include images and [hyperlinks](#) to make things more engaging.
**Do leave some whitespace between paragraphs, so that everything feels easy to read.**
{: .text-justify.big-first }

Want a little nudge on the first line? Use the `indent` class.
You’ll notice some gibberish text in this demo. It’s simply placeholder content, added to give you a sense of how the layout and styling will look. The text itself doesn’t carry any meaning—it’s just there to fill space and make the design feel more complete.
{: .indent.text-justify }

> You can write in a blockquote.
> > "I can stack them too." - _Says the Author_
...
Write something in the `bg-primary.text-white.box`
{: .bg-primary.text-white.box.text-center }

... or use the `bg-secondary.box`
{: .bg-secondary.box.text-center }

Try other mix too.
{: .bg-red.text-yellow-light.box.text-center }
...
<summary>Style with box (click for more)</summary>
<p class="px-4 py">... more contents here.</p>
</details>
...
- This is an unordered level 1 item.
    - level 2 item
        - level 3 item
        - level 3 item
    - level 2 item
...
| Left              | Center       | Right      |
| :---------------- | :----------: | ---------: |
| good fish         | 1,023 pcs    |       nice |
| plenty flany      | out of stock |       yeah |
| biscuik           | 3 ton        |        hmm |
| zoute drop        | ok           |       tumm |
{: .full }

| Full borderless table                         |
| Left              | Center       | Right      |
| :---------------- | :----------: | ---------: |
{: .full.borderless }
